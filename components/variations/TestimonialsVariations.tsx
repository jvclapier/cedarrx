  ...
  testimonials: [
    {
      ...
      text: 'CedarRX has been a lifesaver for my family. Their compounded medications for my daughter\'s allergies have made such a difference. The pharmacists really care.',
      rating: 5,
    },
    {
      id: 2,
      name: 'Michael Chen',
      location: 'Jerome, ID',
      text: 'The weight loss program with personalized GLP-1 medications changed my life. Down 45 pounds and feeling better than ever. Thank you, CedarRX!',
      rating: 5,
    },
    {
      id: 3,
      ...
      text: 'Professional, caring, and knowledgeable. They take time to explain everything and make sure you\'re comfortable with your treatment plan.',
      rating: 5,
    },
    {
      id: 4,
      name: 'David Thompson',
      location: 'Twin Falls, ID',
      text: 'I\'ve been coming here for 10 years. The personalized service and attention to detail is unmatched. Wouldn\'t go anywhere else.',
      rating: 5,
    },
  ],
};
            ...
            >
              ...
              <div className="flex gap-1 mb-4">
                {[...Array(testimonial.rating)].map((_, i) => (
                  <Star key={i} className="w-4 h-4 fill-current text-cedar" />
                ))}
              </div>
