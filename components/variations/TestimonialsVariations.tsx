  ...
  testimonials: [
    {
      ...
      text: 'The pharmacists at Cedar Pharmacy took the time to work with my doctor to find the right compounded solution for me. Excellent communication throughout.',
      rating: 5,
    },
    {
      id: 2,
      name: 'Kristen Andersen',
      location: 'Verified Patient',
    ...
    },
    {
      ...
      name: 'Jack Spangler',
      location: 'Verified Patient',
      text: 'Outstanding quality and service. My doctor recommended Cedar Pharmacy and I\'m so glad they did. The delivery was fast and convenient.',
      rating: 5,
    },
    {
      id: 4,
      name: 'Holly Mangum',
      location: 'Verified Patient',
      text: 'The attention to detail and personalized care sets Cedar Pharmacy apart. They truly go above and beyond for their patients.',
      rating: 5,
    },
  ],
};
